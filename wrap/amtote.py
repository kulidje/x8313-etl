...
WSDL_DEV_MBS = 'http://199.96.45.68/eot/filebet/ww534948?singleWsdl'

# Current public static IP for production server
STATIC_PROD_IP = '18.217.169.51'
STATIC_DEV_MBS_IP = '99.230.113.110'
...
class FileBet:
    ...
    def __init__(self, url=WSDL_DEV):
        ...
        if url == WSDL_DEV_MBS:
            ...
            if  currentIP != STATIC_DEV_MBS_IP:
                raise Exception(
        ...
        try:
            ...
            raise Exception(
                "FileBet ERROR: unable to connect to FileBet client ("
                + self.url
                + " - check VPN health.")
